...
# Retornar a matriz de valores inteiros diferença entre as matrizes M1 e M2,
# i.e., cada item (i,j) do resultado = valor absoluto de (M1[i][j] - M2[i][j]).
# Você pode usar a função abs(x) para obter o valor absoluto de x.
def difMatriz( M1, M2 ):
    ...
