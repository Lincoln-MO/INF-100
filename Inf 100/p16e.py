...
# Retornar um arranjo contendo o maior valor de cada coluna da matriz M.
def pegaMaxColunasMatriz( M ):
    ...

# Dividir cada elemento M[i][j] por V[j]
...
# Criar um arranjo M de n itens contendo o maior valor de cada coluna de A
M = pegaMaxColunasMatriz( A )
